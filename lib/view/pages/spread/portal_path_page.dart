...
class _ThePortalPathPageState extends State<ThePortalPathPage>
  ...
  Widget build(BuildContext context) {
    ...
    double totalWidth =
        imageWidth *
        (1 + (cardsController.cards.length - 1) * (1 - overlapPercentage));
                          ...
                          child: AnimatedSwitcher(
                            ...
                            child: showText
                                ? Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        "“Step through. A path of memory, mirror, and reclamation opens before you. What was. What is. What can now become. Let the portal show you the way.”",
                                        style: TextStyle(
                                          fontSize: 22,
                                          fontFamily: "Sanford",
