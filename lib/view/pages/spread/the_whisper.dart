                  ...
                  return Opacity(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        AddHeight(40),
                        Image.asset("assets/images/spread_blank_card.png",width: 160,height: 270,),
                        Spacer(),
                        Center(
                          child: SizedBox(
                                ...
                                child: SizedBox(
                                  ...
                                  child: Stack(
                                    children: List.generate(itemCount, (index) {
                                      ...
                                      final bool isNearSelected = (index - selectedIndex).abs() <= 1;
                                      print(xOffset);
                                      print(yOffset);
                                      return Positioned(
                                        left: xOffset,
                                        ...
                                        child: GestureDetector(
                                          onTap: () {
                                            double targetOffset = (index * imageWidth * (1 - overlapPercentage)) -
                                                (Get.width / 2) + (imageWidth / 2);

                                            _horizontalScrollController
                                                .animateTo(
                                              targetOffset.clamp(0.0, totalWidth - Get.width),
                                          ...
                                          child: AnimatedContainer(
                                            ...
                                            transform: Matrix4.identity()
                                              ..rotateY(normalizedDistance * 0.15),
