...
class SpiralOfBecomingPage extends StatefulWidget {
  const SpiralOfBecomingPage({super.key});

  @override
  State<SpiralOfBecomingPage> createState() => _SpiralOfBecomingPageState();
}

class _SpiralOfBecomingPageState extends State<SpiralOfBecomingPage>
                      ...
                      children: [
                        ...
                        Expanded(child: AnimatedSwitcher(
                          ...
                          child:  showText
                            ...
                            child: Center(
                              child: Text(
                                "“You are entering the spiral. Where wounds become wisdom, and masks fall away. Breathe. The magic is hidden beneath what you once feared. Let it rise.”",
                                style: TextStyle(
                                  fontSize: 22,
                                  fontFamily: "Sanford",
